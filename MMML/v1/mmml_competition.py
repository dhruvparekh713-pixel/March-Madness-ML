...
# Core tournament-relevant men's teams (extend from Kaggle MTeams.csv)
MENS_TEAM_IDS = {
    'Duke Blue Devils': 1181,
    'Michigan Wolverines': 1277,
    'Arizona Wildcats': 1112,
    'Florida Gators': 1196,
    "St. John's Red Storm": 1370,
    'Iowa State Cyclones': 1234,
    'Alabama Crimson Tide': 1103,
    'Tennessee Volunteers': 1397,
    'Kentucky Wildcats': 1246,
    'Marquette Golden Eagles': 1272,
    'Houston Cougars': 1222,
    'Auburn Tigers': 1116,
    'Wisconsin Badgers': 1458,
    'Ohio State Buckeyes': 1314,
    'Purdue Boilermakers': 1344,
    'Oregon Ducks': 1323,
    'Texas A&M Aggies': 1400,
    'Memphis Tigers': 1276,
    'Illinois Fighting Illini': 1228,
    'Creighton Bluejays': 1163,
    'Dayton Flyers': 1168,
    'Clemson Tigers': 1153,
    'Xavier Musketeers': 1461,
    "Saint Mary's Gaels": 1361,
    'Nebraska Cornhuskers': 1293,
    'Vanderbilt Commodores': 1420,
    'Indiana Hoosiers': 1230,
    'Colorado State Rams': 1157,
    'San Diego State Aztecs': 1366,
    'NC State Wolfpack': 1296,
    'Utah Utes': 1416,
    'Colorado Buffaloes': 1156,
    'Virginia Tech Hokies': 1423,
    'Missouri Tigers': 1284,
    'Georgia Bulldogs': 1200,
    'Oklahoma Sooners': 1318,
    'Utah State Aggies': 1417,
    'Mississippi State Bulldogs': 1282,
    'Boise State Broncos': 1131,
    'Drake Bulldogs': 1178,
    'New Mexico Lobos': 1299,
    'McNeese Cowboys': 1275,
    'Liberty Flames': 1256,
    'Vermont Catamounts': 1422,
    'Colgate Raiders': 1155,
    'High Point Panthers': 1216,
    'Furman Paladins': 1199,
    'Samford Bulldogs': 1364,
    'UC San Diego Tritons': 1411,
    "St. Peter's Peacocks": 1371,
    'Wofford Terriers': 1460,
    'UNC Asheville Bulldogs': 1410,
    'UNCG Spartans': 1413,
    'Robert Morris Colonials': 1352,
    'Mount St. Marys Mountaineers': 1287,
    'Akron Zips': 1102,
    'Longwood Lancers': 1262,
    'NJIT Highlanders': 1303,
    'Texas Southern Tigers': 1402,
    'Alabama State Hornets': 1104,
    'Norfolk State Spartans': 1305,
    'Northern Iowa Panthers': 1307,
    'Michigan State Spartans': 1278,
    'Gonzaga Bulldogs': 1206,
    'Kansas Jayhawks': 1242,
    'Baylor Bears': 1124,
    'BYU Cougars': 1137,
    'Kansas State Wildcats': 1243,
    'TCU Horned Frogs': 1396,
    'Texas Longhorns': 1401,
    'West Virginia Mountaineers': 1449,
    'Iowa Hawkeyes': 1233,
    'Minnesota Golden Gophers': 1281,
    'Northwestern Wildcats': 1309,
    'Penn State Nittany Lions': 1332,
    'Rutgers Scarlet Knights': 1357,
    'Michigan': 1277,
    'Arizona State Sun Devils': 1113,
    'UCLA Bruins': 1408,
    'USC Trojans': 1415,
    'Washington Huskies': 1443,
    'Oregon State Beavers': 1324,
    'California Golden Bears': 1139,
    'Stanford Cardinal': 1380,
    'Utah Valley Wolverines': 1419,
    'UConn Huskies': 1163,  # Note: men's UConn
    'Connecticut Huskies': 1163,
    'Florida Atlantic Owls': 1195,
    'Charleston Cougars': 1147,
    'Iona Gaels': 1232,
    'Vermont': 1422,
    'Oral Roberts Golden Eagles': 1321,
    'South Dakota State Jackrabbits': 1376,
    'Murray State Racers': 1291,
    'Montana State Bobcats': 1285,
    'Northern Kentucky Norse': 1308,
    'Yale Bulldogs': 1463,
    'Princeton Tigers': 1342,
    'Harvard Crimson': 1213,
    'Columbia Lions': 1159,
    'Cornell Big Red': 1162,
    'Brown Bears': 1136,
    'Dartmouth Big Green': 1167,
    'Penn Quakers': 1331,
    'Belmont Bruins': 1127,
    'Chattanooga Mocs': 1149,
    'ETSU Buccaneers': 1192,
    'Furman': 1199,
    'Mercer Bears': 1275,
    'Samford': 1364,
    'VMI Keydets': 1425,
    'Western Carolina Catamounts': 1447,
    'Wofford': 1460,
    'Davidson Wildcats': 1166,
    'Rhode Island Rams': 1349,
    'UMass Minutemen': 1412,
    'George Mason Patriots': 1202,
    'La Salle Explorers': 1249,
    'Richmond Spiders': 1350,
    'VCU Rams': 1421,
    'Duquesne Dukes': 1183,
    'George Washington Revolutionaries': 1203,
    'Saint Louis Billikens': 1362,
    'Butler Bulldogs': 1138,
    'DePaul Blue Demons': 1172,
    'Georgetown Hoyas': 1204,
    'Providence Friars': 1343,
    'Seton Hall Pirates': 1372,
    'Villanova Wildcats': 1424,
    'Miami Hurricanes': 1279,
    'Louisville Cardinals': 1263,
    'Notre Dame Fighting Irish': 1311,
    'Pittsburgh Panthers': 1337,
    'Syracuse Orange': 1393,
    'Wake Forest Demon Deacons': 1433,
    'Boston College Eagles': 1133,
    'Georgia Tech Yellow Jackets': 1201,
    'Florida State Seminoles': 1197,
    'Virginia Cavaliers': 1422,
    'North Carolina Tar Heels': 1301,
    'Duke': 1181,
    'Arkansas Razorbacks': 1114,
    'LSU Tigers': 1260,
    'Mississippi Rebels': 1283,
    'South Carolina Gamecocks': 1375,
    'Vanderbilt': 1420,
    'Texas Tech Red Raiders': 1403,
    'Oklahoma State Cowboys': 1319,
    'Cincinnati Bearcats': 1152,
    'UCF Knights': 1409,
    'Wichita State Shockers': 1454,
    'Tulsa Golden Hurricane': 1407,
    'SMU Mustangs': 1368,
    'Temple Owls': 1398,
    'East Carolina Pirates': 1185,
    'Navy Midshipmen': 1292,
    'Army Black Knights': 1115,
    'Lehigh Mountain Hawks': 1254,
    'Holy Cross Crusaders': 1221,
    'American Eagles': 1107,
    'Bucknell Bison': 1137,
    'Loyola Maryland Greyhounds': 1265,
    'Colgate': 1155,
    'Boston University Terriers': 1134,
    'Northeastern Huskies': 1306,
    'Albany Great Danes': 1101,
    'Binghamton Bearcats': 1130,
    'Hartford Hawks': 1211,
    'Maine Black Bears': 1269,
    'New Hampshire Wildcats': 1298,
    'Stony Brook Seawolves': 1385,
    'UMBC Retrievers': 1411,
    'UMass Lowell River Hawks': 1413,
    'Central Connecticut Blue Devils': 1145,
    'Bryant Bulldogs': 1136,
    'LIU Sharks': 1258,
    'Merrimack Warriors': 1276,
    'Sacred Heart Pioneers': 1358,
    'Saint Francis Red Flash': 1359,
    'Wagner Seahawks': 1432,
    'Fairleigh Dickinson Knights': 1193,
    'Monmouth Hawks': 1284,
    'Rider Broncs': 1351,
    'Marist Red Foxes': 1271,
    'Niagara Purple Eagles': 1302,
    'Siena Saints': 1374,
    'Canisius Golden Griffins': 1141,
    'Quinnipiac Bobcats': 1345,
    'Manhattan Jaspers': 1270,
    'Fairfield Stags': 1192,
    'SIU Edwardsville Cougars': 1374,
    'UT Arlington Mavericks': 1415,
    'Texas State Bobcats': 1402,
    'South Alabama Jaguars': 1375,
    'Louisiana Ragin Cajuns': 1264,
    'Georgia Southern Eagles': 1201,
    'Old Dominion Monarchs': 1320,
    'Charlotte 49ers': 1148,
    'Florida International Panthers': 1195,
    'Middle Tennessee Blue Raiders': 1280,
    'Western Kentucky Hilltoppers': 1448,
    'UAB Blazers': 1408,
    'Marshall Thundering Herd': 1272,
    'Rice Owls': 1349,
    'North Texas Mean Green': 1304,
    'Southern Miss Golden Eagles': 1379,
    'UTSA Roadrunners': 1416,
    'Louisiana Tech Bulldogs': 1263,
    'Tulane Green Wave': 1406,
}

WOMENS_TEAM_IDS = {
    'UConn Huskies': 3163,
    'South Carolina Gamecocks': 3376,
    'UCLA Bruins': 3408,
    'Texas Longhorns': 3400,
    'Notre Dame Fighting Irish': 3310,
    'Iowa Hawkeyes': 3233,
    'LSU Tigers': 3259,
    'Baylor Bears': 3124,
    'Maryland Terrapins': 3271,
    'Stanford Cardinal': 3380,
    'Ohio State Buckeyes': 3314,
    'NC State Wolfpack': 3296,
    'Indiana Hoosiers': 3230,
    'Kentucky Wildcats': 3246,
    'Duke Blue Devils': 3181,
    'Oklahoma Sooners': 3318,
    'Virginia Tech Hokies': 3423,
    'Tennessee Lady Vols': 3397,
    'Arizona Wildcats': 3112,
    "St. John's Red Storm": 3370,
    'Michigan State Spartans': 3278,
    'Gonzaga Bulldogs': 3206,
    'Kansas State Wildcats': 3243,
    'Florida Gators': 3196,
    'Georgia Lady Bulldogs': 3200,
    'West Virginia Mountaineers': 3449,
    'Chattanooga Mocs': 3149,
    "Saint Mary's Gaels": 3361,
    'Iona Gaels': 3232,
    'Hartford Hawks': 3211,
    'Maine Black Bears': 3269,
    'Howard Bison': 3222,
    'Sacred Heart Pioneers': 3358,
    'Prairie View A&M Panthers': 3341,
    'SIU Edwardsville Cougars': 3374,
    'Oregon Ducks': 3323,
    'Georgia Tech Yellow Jackets': 3201,
    'Virginia Tech': 3423,
    'Fordham Rams': 3197,
    'Longwood Lancers': 3262,
    'NJIT Highlanders': 3303,
    'Texas A&M-CC Islanders': 3400,
    'UC Davis Aggies': 3409,
    'Missouri Tigers': 3284,
    'Arkansas Razorbacks': 3114,
    'Alabama Crimson Tide': 3103,
    'Boston University Terriers': 3134,
    "St. John's Red Storm (W)": 3370,
    'Columbia Lions': 3159,
    'Old Dominion Monarchs': 3320,
    'Delaware Fightin Blue Hens': 3170,
    'Utah State Aggies': 3417,
    'Nebraska Cornhuskers': 3293,
    'Washington Huskies': 3443,
    'Ball State Cardinals': 3122,
    'Princeton Tigers': 3342,
    'Southern Utah Thunderbirds': 3379,
    'Norfolk State Spartans': 3305,
    'Florida State Seminoles': 3197,
    'Michigan Wolverines': 3277,
    'Colorado Buffaloes': 3156,
    'South Florida Bulls': 3377,
    'Illinois Fighting Illini': 3228,
    'Utah Utes': 3416,
    'Tennessee': 3397,
    'Oklahoma': 3318,
    'Colorado': 3156,
...
RAW_HISTORICAL = [
    # Men's — upsets and close games (all-time tournament)
    (12,14.2,70.1,5,18.4,71.2,'M'), (11,12.1,73.4,6,16.3,70.8,'M'),
    (10,10.8,72.1,7,14.2,70.4,'M'), (9,8.4,71.4,8,9.2,71.8,'M'),
    (13,8.1,68.4,4,21.3,70.9,'M'), (14,5.2,67.8,3,24.1,70.4,'M'),
    (11,13.4,74.1,6,15.8,69.8,'M'), (5,17.2,69.8,12,11.4,70.1,'M'),
    (1,38.1,70.2,16,-6.2,68.4,'M'), (2,28.4,71.1,15,-3.1,69.2,'M'),
    (3,23.8,70.4,14,4.8,68.8,'M'), (4,20.1,70.8,13,7.2,69.4,'M'),
    (1,35.2,69.8,8,9.4,71.8,'M'), (1,32.4,70.1,5,17.8,70.2,'M'),
    (2,27.3,71.4,10,11.2,72.8,'M'), (3,22.1,70.8,6,14.8,70.4,'M'),
    (1,36.8,68.9,4,20.8,71.2,'M'), (2,29.1,71.8,3,23.4,70.1,'M'),
    # More upsets
    (11,14.8,72.8,6,14.1,70.2,'M'), (12,13.2,71.4,5,15.8,70.8,'M'),
    (10,11.4,73.1,7,13.4,70.4,'M'), (9,9.8,72.4,8,10.1,70.8,'M'),
    (15,3.2,69.4,2,26.8,71.4,'M'), (14,6.8,68.1,3,22.8,70.8,'M'),
    (13,9.4,70.8,4,19.8,70.4,'M'), (11,15.1,74.8,6,14.8,69.4,'M'),
    # Favorites winning
    (1,40.6,69.1,16,-5.8,68.2,'M'), (1,39.8,70.4,16,-4.2,67.8,'M'),
    (2,29.4,71.2,15,-2.8,69.1,'M'), (1,35.8,70.1,8,9.8,71.8,'M'),
    (1,37.4,69.8,4,21.2,70.4,'M'), (1,38.2,70.8,2,28.4,71.1,'M'),
    (1,36.1,69.4,3,24.8,70.8,'M'), (1,40.1,70.2,3,23.1,70.4,'M'),
    # 2024 NCAA tournament sample
    (1,38.8,70.1,16,-5.1,68.8,'M'), (12,12.8,71.8,5,16.4,70.4,'M'),
    (11,14.1,74.2,6,15.2,69.8,'M'), (5,17.8,70.2,12,11.8,71.2,'M'),
    (8,9.8,72.8,9,8.8,70.8,'M'), (1,37.2,69.4,8,9.2,72.4,'M'),
    (2,28.1,71.4,10,11.4,73.2,'M'), (1,36.4,70.8,5,17.4,70.1,'M'),
    (1,39.1,70.1,2,27.8,71.2,'M'),  # Championship game
    # 2023
    (15,4.8,70.4,2,27.4,71.8,'M'), (13,9.8,69.8,4,19.4,70.4,'M'),
    (5,18.1,70.8,12,12.1,71.4,'M'), (1,37.8,69.8,16,-4.8,68.4,'M'),
    (1,36.8,70.4,5,17.8,70.8,'M'), (9,9.4,72.1,8,10.1,71.8,'M'),
    (11,14.8,74.1,6,14.4,70.2,'M'), (1,38.4,70.2,4,21.4,70.8,'M'),
    (3,24.4,70.8,1,36.1,69.8,'M'),  # Upset: 3 over 1 semis
    # Women's
    (1,38.4,70.1,16,-3.2,68.8,'W'), (1,42.1,70.8,16,-2.8,68.4,'W'),
    (2,28.4,71.1,15,1.2,69.8,'W'), (1,36.8,71.2,8,8.4,72.1,'W'),
    (3,22.8,70.4,14,4.1,68.4,'W'), (4,18.4,71.2,13,6.8,69.8,'W'),
    (5,14.8,70.8,12,9.1,70.4,'W'), (6,11.4,70.4,11,10.8,72.1,'W'),
    (1,40.1,70.4,4,18.8,71.2,'W'), (2,27.4,71.4,3,21.8,70.8,'W'),
    (1,38.8,70.8,2,27.1,71.1,'W'), (1,41.4,70.1,3,22.4,70.4,'W'),
    (8,8.8,72.4,9,8.1,71.8,'W'), (7,11.2,71.8,10,10.1,72.4,'W'),
    (11,11.4,72.8,6,12.8,70.1,'W'), (10,10.8,73.1,7,11.4,70.8,'W'),
    (1,42.1,70.8,2,28.4,71.1,'W'), (1,38.4,70.4,1,36.8,71.2,'W'),
    (2,28.8,71.2,1,37.8,70.1,'W'), (3,23.4,70.8,2,27.1,71.4,'W'),
    (12,10.4,71.4,5,15.8,70.8,'W'), (1,39.8,70.4,16,-2.4,68.2,'W'),
    (1,37.4,71.1,8,8.8,72.8,'W'), (2,26.8,71.8,4,18.4,71.2,'W'),
    (1,41.8,70.4,3,21.8,70.8,'W'), (2,27.4,71.4,1,36.8,70.1,'W'),
]


def build_training_data():
    """Build training set from historical games with enhanced features."""
    X, y = [], []
    for row in RAW_HISTORICAL:
        sw, em_w, t_w, sl, em_l, t_l, g = row

        team_w = {
            'seed': sw, 'adj_em': em_w, 'adj_o': 100 + em_w,
            'adj_d': 100, 'adj_t': t_w, 'gender': g,
            'net_rank': sw * 3, 'q1_wins': max(0, 10-sw),
            'q1_losses': sw, 'q2_wins': max(0, 7-sw),
            'q2_losses': max(0, sw-3), 'coach_exp': 10,
            'returning_min_pct': 70, 'last10_wins': max(4, 10-sw//2),
            'scoring_margin': em_w * 0.35, 'luck': 0.0,
            'sos': em_w * 0.4, 'wab': 5 - sw*0.3, 'kpi': em_w * 1.1,
            'conf_tourney_result': 2 if sw <= 2 else 1,
        }
        team_l = {
            'seed': sl, 'adj_em': em_l, 'adj_o': 100 + em_l,
            'adj_d': 100, 'adj_t': t_l, 'gender': g,
            'net_rank': sl * 3, 'q1_wins': max(0, 10-sl),
            'q1_losses': sl, 'q2_wins': max(0, 7-sl),
            'q2_losses': max(0, sl-3), 'coach_exp': 8,
            'returning_min_pct': 68, 'last10_wins': max(4, 10-sl//2),
            'scoring_margin': em_l * 0.35, 'luck': 0.0,
            'sos': em_l * 0.4, 'wab': 5 - sl*0.3, 'kpi': em_l * 1.1,
            'conf_tourney_result': 2 if sl <= 2 else 1,
        }

        feat = get_features_enhanced(team_w, team_l)
        # label=1 means fav wins; if winner has lower seed, fav=winner
...
# ─────────────────────────────────────────────────────────────────────────────
# 6.  COMPETITION PREDICTOR
# ─────────────────────────────────────────────────────────────────────────────

class CompetitionPredictor:
    """
    Enhanced ensemble for the MMML competition.
    Outputs P(team_a wins) for any matchup given team IDs.
    """
    ...
    def __init__(self):
        ...
        self.rf  = RandomForestClassifier(
            n_estimators=400, max_depth=5, min_samples_split=4, random_state=42)
        self.lr  = LogisticRegression(C=0.8, max_iter=1000, random_state=42)
    ...
    def train(self):
        ...
        print(f"  Competition model trained. CV AUC: {auc:.4f}")
    ...
    def predict_prob(self, team_a, team_b):
        ...
        p_fav = 0.50 * p_gbm + 0.35 * p_rf + 0.15 * p_lr
        p_fav = np.clip(p_fav, 0.01, 0.99)

        # p_fav = P(lower seed wins)
        # If team_a is the lower seed (fav), return p_fav directly
